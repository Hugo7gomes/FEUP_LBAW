...
| R04               | task(**id_task**, name NN, state NN CK state IN State DF 'To do',details, creation_date NN, priority NN CK priority IN Priority, id_user_assigned->authenticated_user,id_user_creator->authenticated_user NN, proj_id->project) |
